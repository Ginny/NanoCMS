<?php //netteCache[01]000378a:2:{s:4:"time";s:21:"0.68687100 1308008845";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:56:"/var/www/MojoCMS/app/AdminModule/templates/@layout.latte";i:2;i:1308006651;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"d5b50dc released on 2011-06-03";}}}?><?php

// source file: /var/www/MojoCMS/app/AdminModule/templates/@layout.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'q6vgdi3hjk')
;//
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lb9c7a5f5ff5_title')) { function _lb9c7a5f5ff5_title($_l, $_args) { extract($_args)
;
}}
...
<?php endif ?>
        ...
        <script src="<?php echo htmlSpecialChars($basePath) ?>/js/jquery.livequery.js" type="text/javascript"></script>
...
<?php if ($user->loggedIn): ?>
        <p id="logged-in">Signed in as <?php echo Nette\Templating\DefaultHelpers::escapeHtml($user->identity->real_name, ENT_NOQUOTES) ?>
